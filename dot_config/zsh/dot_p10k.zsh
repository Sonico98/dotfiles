# Generated by Powerlevel10k configuration wizard on 2021-08-23 at 10:21 -03.
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=09
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local       meta='%247F'  # grey foreground
      local      clean='%247F'  # grey foreground
      local   modified='%247F'  # grey foreground
      local  untracked='%247F'  # grey foreground
      local conflicted='%247F'  # grey foreground
    fi
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_FOREGROUND=03
  ...
  ####################################[ time: current time ]####################################
  # Current time color.
  typeset -g POWERLEVEL9K_TIME_FOREGROUND=09
